...
// NewCCEV1Client returns a *ServiceClient for making calls to the
...
func NewCCEV1Client() (*golangsdk.ServiceClient, error) {
	...
	return openstack.NewCCEV1(client, golangsdk.EndpointOpts{
		Region: os.Getenv("OS_REGION_NAME"),
	})
}
...
func NewCCEV3Client() (*golangsdk.ServiceClient, error) {
	...
	return openstack.NewCCEV3(client, golangsdk.EndpointOpts{
		Region: os.Getenv("OS_REGION_NAME"),
	})
}
