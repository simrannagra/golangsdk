...
var GetExpected =&cluster.RetrievedCluster{
		Kind:         "cluster",
		ApiVersion:   "v1",
		...
		Clusterspec:  cluster.ClusterlistSpec{AZ:"eu-de-01",
			...
			ClusterHostList: cluster.ClusterHostList{Kind:"list",
				...
				HostListSpec: cluster.HostListSpec{HostList: []cluster.Host{{Kind: "host",
					ApiVersion: "v1",
					...
					Hostspec: cluster.HostSpec{ClusterUuid: "d83af16b-febd-4e52-bfb0-20850072e2cd",
						...
						HostStatus: cluster.HostStatus{Capacity: cluster.Capacity{CPU: "1", Memory: "3844320Ki", Pods: "110"},
		...
		ClusterStatus: cluster.ClusterStatus{Status:"AVAILABLE"},
		K8sVersion:    "1.7.3",
	}
